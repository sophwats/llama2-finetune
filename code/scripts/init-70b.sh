echo "Initializing the 70B model."

if [ ! -f /project/models/llama-70b.nemo ]; then
    ...
    echo "llama-70b.nemo is ready"
else
    echo "llama-70b.nemo already exists. Skipping."
fi

sleep 5
echo "70B model is initialized."